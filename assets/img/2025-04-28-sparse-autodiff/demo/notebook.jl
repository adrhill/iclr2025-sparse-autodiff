...
# ╔═╡ 9691874a-4156-4201-8f28-935f6ccd259a
md"""
# Automatic sparse differentiation in Julia
"""

# ╔═╡ b9edc0d3-9ab0-4ba0-9c6f-45e7c4214005
md"""
## Setup
"""

# ╔═╡ 05d7161b-33c0-4d1d-b4e3-2856f73069d3
...
function visualize_diff(d, n)
	...
	A_img, B_img = show_colors(prep.coloring_result; colorscheme, scale=5, pad=1)
	return A_img
end
...
begin
	...
	for (i, d) in enumerate(d_vals), (j, n) in enumerate(n_vals)
		...
		Images.save("diff_coloring_d=$(d)_n=$(n).png", img)
	end
end
...
manifest_format = "2.0"
project_hash = "7ab9a1aba8a297cdcfeab6fa145cc043c688762a"
